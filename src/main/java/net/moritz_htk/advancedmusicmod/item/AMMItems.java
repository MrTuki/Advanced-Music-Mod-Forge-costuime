...
public class AMMItems {
    ...
    public static final RegistryObject<Item> MUSIC_DISC_ALICE = ITEMS.register("music_disc_alice", () -> new RecordItem(8, AMMSoundEvents.MUSIC_DISC_ALICE, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 4940));
